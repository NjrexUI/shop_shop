...
class Products with ChangeNotifier {
  ...
  List<Product> get favoriteYtems {
    return items.where((prodItem) => prodItem.isFavourite).toList();
  }
  ...
  Future<void> fetchAndSetProducts() async {
    final url =
        "https://flutter-shop-app-1c339-default-rtdb.firebaseio.com/products.json";
    try {
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final url =
          "https://flutter-shop-app-1c339-default-rtdb.firebaseio.com/products/$id.json";
      await http.patch(
        url,
        body: json.encode(
          {
